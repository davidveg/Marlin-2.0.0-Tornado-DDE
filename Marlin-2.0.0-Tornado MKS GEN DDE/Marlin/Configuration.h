 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 39.10  // Values set for Petsfang V2  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -13.00  // Y offset: -front +behind [the nozzle]
